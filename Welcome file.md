...
<p>Hi! I’m your first Markdown</p>
<p>file in <strong>StackEdit</strong>. If you want to learn about StackEdit, you can read me. If you want to play with Markdown, you casss</p>
<hr>
<p>n edit me. If you have finished with me, you can just create new files by opening the <strong>file explorer</strong> on the left corner of the navigation bar.</p>
...
<p>The <em>Gamma function</em> satisfying <span class="katex--inline">KaTeX parse error: Expected 'EOF', got '−' at position 8: Γ(n)=(n−̲1)!∀n∈N\Gamma(n…</span> is via the Euler integral</p>
<p><span class="katex--display">KaTeX parse error: Expected 'EOF', got '−' at position 11: Γ(z)=∫0∞tz−̲1e−tdt.
\Gamma(…</span></p>
<blockquote>
